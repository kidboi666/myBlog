...
const containerVariants = cva("flex items-center justify-center", {
  variants: {
    variant: {
      ...
      main: "relative mb-12 mt-52 grid h-full w-full animate-fadeIn grid-cols-1 items-start gap-14 rounded-3xl bg-white px-4 py-12 shadow-md md:px-12 2xl:grid-cols-2",
      post: "mb-12 mt-28 grid h-full w-full max-w-[864px] animate-fadeIn grid-cols-1 items-start gap-4 rounded-3xl bg-white px-4 py-12 shadow-md md:px-12",
